<?php
/**
	* Plugin Name: arf-core
	* Description: Theme_Pure elementor core plugin.
...
include_once(TPCORE_ADDONS_DIR . '/include/social-share.php');
include_once(TPCORE_ADDONS_DIR . '/include/user-social.php');
include_once(TPCORE_ADDONS_DIR . '/include/traits-builder.php');
