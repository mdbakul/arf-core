...
class TP_Header_04 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Header Builder 4', 'tpcore' );
	}
	...
	protected function render() {
        ...
        if ('2' == $settings['tp_rBtn2_link_type']) {
            ...
            $this->add_render_attribute('tp-button-arg2', 'class', 'tp-el-btn2');
        } else {
...
<header>
    <div id="header-sticky" class="<?php echo $settings['tp_header_trans_switch'] ? "tptransparent__header" : NULL; ?> tpheader__three tp-white-menu theme-bg-4 pl-185 pr-185 builder-header-4 tp-el-section">
