...
class TP_Header_07 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Header Builder 7', 'tpcore' );
	}
...
<header>
    <div id="header-sticky" class="<?php echo $settings['tp_header_trans_switch'] ? "tptransparent__header" : NULL; ?> header-spaces builder-header-7 tp-el-section">
        <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-6 col-sm-4 col-6">
                        ...
                        <div class="tplogo__area">
                            <a class="tp-el-logo" href="<?php print esc_url( home_url( '/' ) );?>">
