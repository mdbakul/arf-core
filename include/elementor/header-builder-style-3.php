...
class TP_Header_03 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Header Builder 3', 'tpcore' );
	}
...
<header>
    <div id="header-sticky" class="<?php echo $settings['tp_header_trans_switch'] ? "tptransparent__header" : NULL; ?> header-green header-spaces builder-header-3 tp-el-section">
        <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-8 col-6">
                        <div class="tpheader__right d-flex align-items-center justify-content-end">
                            ...
                            <?php if(!empty($settings['tp_header_right_switch'] && $settings['tp_rBtn1_text'])) : ?>
