...
class TP_Header_01 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Header Builder 1', 'tpcore' );
	}
	...
	protected function register_controls_section() {
        ...
        $this->add_control(
            'tp_image2',
            [
                'label' => esc_html__( 'Choose Sticky Logo', 'tp-core' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
        ...
        $this->tp_builder_button_links('rBtn2', 'Right Button 2');
    ...
    protected function style_tab_content(){
        ...
        $this->tp_link_controls_style('btn2_style', 'Button 2', '.tp-el-btn2');
        # offcanvas
	...
	protected function render() {
	    ...
	    if ( !empty($settings['tp_image2']['url']) ) {
	        $tp_image2 = !empty($settings['tp_image2']['id']) ? wp_get_attachment_image_url( $settings['tp_image2']['id'], $image_size, true) : $settings['tp_image2']['url'];
        ...
        if ('2' == $settings['tp_rBtn1_link_type']) {
            ...
            $this->add_render_attribute('tp-button-arg', 'class', 'tp-el-btn1');
        } else {
        ...
        // Link 2
        if ('2' == $settings['tp_rBtn2_link_type']) {
            $this->add_render_attribute('tp-button-arg2', 'href', get_permalink($settings['tp_rBtn2_page_link']));
            $this->add_render_attribute('tp-button-arg2', 'target', '_self');
            $this->add_render_attribute('tp-button-arg2', 'rel', 'nofollow');
            $this->add_render_attribute('tp-button-arg2', 'class', 'tp-header-btn tp-el-btn2');
        } else {
            if ( ! empty( $settings['tp_rBtn2_link']['url'] ) ) {
                $this->add_link_attributes( 'tp-button-arg2', $settings['tp_rBtn2_link'] );
                $this->add_render_attribute('tp-button-arg2', 'class', 'tp-header-btn tp-el-btn2');
            }
        } 
...
<header>
    <div id="header-sticky" class="<?php echo $settings['tp_header_trans_switch'] ? "tptransparent__header" : NULL; ?> tp-white-menu header-spaces tp-el-section builder-header-1">
        <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-6 col-sm-4 col-6">
                        ...
                        <div class="tplogo__area">
                            ...
                            <a class="sticky-logo tp-el-logo" href="<?php print esc_url( home_url( '/' ) );?>">
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-8 col-6">
                        ...
                        <div class="tpheader__right tpheader__right-white  d-flex align-items-center justify-content-end">
                            <div class="d-flex align-items-center">
                                ...
                                <?php endif; ?>
                                <?php if(!empty($settings['tp_rBtn2_text'])) : ?>
                                <div class="tpheader__btn ml-25 d-none d-md-block">
                                    <a <?php echo $this->get_render_attribute_string( 'tp-button-arg2' ); ?> ><?php echo tp_kses($settings['tp_rBtn2_text']);?></a>
                                </div>
                                <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if ( $settings['tp_header_right_switch'] === 'no' ) : ?>
                        <div class="tpheader__right tpheader__right-white d-xl-none  d-flex align-items-center justify-content-end">
                            <div class="d-flex align-items-center">
                                <div class="offcanvas-btn d-xl-none ml-20">
                                    <button class="offcanvas-open-btn offcanvas-open-btn-white"><i
                                        class="fa-solid fa-bars"></i></button>
