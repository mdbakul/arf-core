 ...
 * @since 1.0.0
 */
class TP_Header_06 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Header Builder 6', 'tpcore' );
	}
...
<header>
    <div id="header-sticky" class="<?php echo $settings['tp_header_trans_switch'] ? "tptransparent__header" : NULL; ?> header-five pl-185 pr-185 builder-header-6 tp-el-section">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-8 col-6">
                        <div class="tpheader__right  d-flex align-items-center justify-content-end">
                            <?php if(!empty($settings['tp_header_lang_switch'] && $settings['tp_header_right_switch'])) : ?>
                            <div class="header-bottom__lang d-none d-lg-block d-flex align-items-center justify-content-end">
                                <?php echo seomy_header_lang_defualt();?>
                            </div>
                            <?php endif; ?>
                            <div class="d-flex align-items-center">
                                <?php if(!empty($settings['tp_rBtn1_text'] && $settings['tp_header_right_switch'])) : ?>
...
$widgets_manager->register( new TP_Header_06() );