...
trait TPCoreElementFunctions
{
     ...
     */
    protected function tp_icon_style($control_id = null, $control_name = 'Icon/Image Style', $selector = '.single-service .icon', $condition = null){
        $section_args = [
    ...
    */
    ...
    protected function tp_link_controls_style($control_id = null, $control_name = null, $control_selector = null, $condition = null)
    {
        /**
         * Button One
         */
    ...
    */
    protected function tp_section_title_render_controls($control_id = null, $section_name = 'Section Title',  $sub_title = 'Sub Title', $default_title = 'Your Section Title', $default_description = 'There are many variations of passages of Lorem Ipsum available, <br /> but the majority have suffered alteration.', $condition='layout-1', $default_title_tag = 'h2', $default_align = 'text-left',  $enable_section_title_show_hide = true, $default_section_title_enable = 'yes')
    {
        $this->start_controls_section(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => false,
				'selectors' => [
					'{{WRAPPER}} .ele-content-align' => 'text-align: {{VALUE}};',
				],
                'condition' => [
                    'tp_' . $control_id . '_section_title_show' => 'yes'
                ]
    ...
    */
    ...
    protected function tp_section_title_render($control_id = null, $title_args = 'section__title' )
    {
    ...
    protected function tp_button_controls_render($control_id = null, $control_name = 'tp-btn' , $settings = null)
    {

        if ('2' == $settings['tp_' . $control_id .'_btn_link_type']) {
            $this->add_render_attribute('tp-button-arg', 'href', get_permalink($settings['tp_' . $control_id .'_btn_page_link']));
            $this->add_render_attribute('tp-button-arg', 'target', '_self');
            $this->add_render_attribute('tp-button-arg', 'rel', 'nofollow');
            $this->add_render_attribute('tp-button-arg', 'class', ''.$control_name.'');
        } else {
            if ( ! empty( $settings['tp_' . $control_id .'_btn_link']['url'] ) ) {
                $this->add_link_attributes( 'tp-button-arg', $settings['tp_' . $control_id .'_btn_link'] );
                $this->add_render_attribute('tp-button-arg', 'class', ''.$control_name.'');
            }
        }
    ...
    */
    ...
    protected function tp_columns($control_id = 'columns_options', $condition = 'layout-1', $control_name = 'Select Columns', $default_for_lg = '4', $default_for_md = '6', $default_for_sm = '6', $default_for_all = '12'){
        $this->start_controls_section(
    ...
    */
    ...
    protected function tp_query_controls($control_id = null, $control_name = null, $post_type = 'any', $default_title_num = 6, $default_content_limit = '10', $taxonomy = 'category', $posts_per_page = '3', $offset = '0', $orderby = 'date', $order = 'desc')
    {
    ...
    protected function tp_icon_controls($control_id = null, $control_condition = 'layout-1'){
    ...
    protected function tp_progressbar_style_controls($control_id = null, $control_name = null, $control_selector = null, $condition = null)
    {
...
function format_post(){
    ...
    <?php if ( !empty( $ninico_audio_url ) ): ?>
    <div class="blog-list-thumb postbox__audio m-img p-relative">
        <?php echo wp_oembed_get( $ninico_audio_url ); ?>
    </div>
    <?php endif; ?>
    <!-- if post has video -->
    ...
    <div class="blog-list-thumb p-relative">
        <a href="<?php the_permalink();?>"><?php the_post_thumbnail( 'full', ['class' => 'img-responsive'] );?></a>
        <div class="tpblog-video-2 d-flex justify-content-center">
            <?php if(!empty($seomy_video_url)) : ?>
            <a class="popup-video" href="<?php print esc_url( $seomy_video_url );?>">
                <i>
                <svg width="15" height="18" viewBox="0 0 15 18" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 9L0 17.6603L0 0.339746L15 9Z" fill="#0C1338"></path>
                </svg>
                </i>
            </a>
            <?php endif; ?>
    ...
    $gallery_images = function_exists('tpmeta_gallery_field')? tpmeta_gallery_field('seomy_post_gallery') : '';    
    ?>

    <?php if ( !empty( $gallery_images ) ): ?>
    <div class="blog-list-thumb-slide">
        <div class="swiper-container tpblog-list-active">
            ...
            <div class="tpblog-grid-btn d-flex align-items-center">
                <div class="blog-list-active-button-prev"><i class="fa-regular fa-angle-left"></i></div>
                <div class="blog-list-active-button-next"><i class="fa-regular fa-angle-right"></i></div>
            </div>
        </div>
    </div>
    <?php endif; ?>
...
function format_post2(){
    ...
    <?php elseif ( has_post_format('video') ): ?>
        <?php if ( has_post_thumbnail() ): ?>
        <div class="tpblog-thumb-2 p-relative">
            <a href="<?php the_permalink();?>"><?php the_post_thumbnail( 'full', ['class' => 'img-responsive'] );?></a>
            <?php if(!empty($seomy_video_url)) : ?>
            <div class="tpblog-video-2">
                <a class="popup-video" href="<?php print esc_url( $seomy_video_url );?>">
                    <i>
                        <svg width="15" height="18" viewBox="0 0 15 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="tpblog-grid-slider">
        <div class="swiper-container tpblog-grid-active">
            <div class="swiper-wrapper">
                ...
                <!-- <div class="swiper-slide">
                    <div class="tpblog-thumb-2">
                        <a href="blog-details.html"><img src="assets/img/blog/blog-grid-3.jpg"
                            alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="tpblog-thumb-2">
                        <a href="blog-details.html"><img src="assets/img/blog/blog-grid-2.jpg"
                            alt=""></a>
                    </div>
                </div> -->
            ...
            <div class="tpblog-grid-btn d-flex align-items-center">
                <div class="blog-grid-active-button-prev"><i
                        class="fa-regular fa-angle-left"></i></div>
                <div class="blog-grid-active-button-next"><i
